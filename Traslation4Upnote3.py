...
class TooltipWindow(QWidget):
    ...
    def initUI(self):
        self.clip_text = pyperclip.paste()
        ...
        self.speakButton = QPushButton("Speak Clipboard Text", self)
        self.speakButton.clicked.connect(lambda: speak(self.clip_text))
        ...
        self.start_background_task(self.clip_text)
